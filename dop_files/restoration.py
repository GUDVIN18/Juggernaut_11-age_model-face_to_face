...
# Построение пути относительно текущей директории
codeformer_path = os.path.normpath(os.path.join(current_dir, '..', 'CodeFormer', 'CodeFormer'))
print('codeformer_path', codeformer_path)
